...
class PyTorch(PythonPackage, CudaPackage, ROCmPackage):
    ...
    variant("flash_attention", default=True, description="Use flash attention")
    ...
    depends_on("gloo+rocm", when="+gloo+rocm")
    ...
    patch("rocm-CMakeLists.txt.patch", when="@2.5.1+rocm")
    ...
    def setup_build_environment(self, env):
        ...
        if "+rocm" in self.spec:
            env.append_flags('CXXFLAGS', '-mcmodel=large')
        ...
        if "+flash_attention" in self.spec:
